...
import { goalContributionService } from '@/services/goal-contribution.service'
...
export default function EditContributionModal({ isOpen, onClose, editItem, onDelete }: EditContributionModalProps) {
  const { user } = useAuth()
  ...
  const [date, setDate] = useState(normalizeDateString(editItem.date))
  ...
  useEffect(() => {
    ...
    setDate(normalizeDateString(editItem.date))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await goalContributionService.update(editItem.id, {
        value: numericValue,
        date: date || undefined,
